...
## 🇬🇧 English *(Store primary language)*
...
**Description:**
```
Every day, millions of people are forced to retype text they already have: because a website decided to block paste.
...
🧠 Ultra-Human Mode: Adds realistic typos and self-corrections for an even more human-like profile.

⚡ Adjustable Speed: Slow, Normal, Fast, or Instant. You control the rhythm.

🕵️ Incognito Mode: Sensitive text is never stored in history.

🔑 Keyboard Shortcut: Alt+Shift+V (Win) / Option+Shift+V (Mac) for instant paste anywhere.

🌍 6 Languages: English, Français, Español, Português, Italiano, Deutsch.

🔒 100% Private: No data ever leaves your computer. Everything is processed locally.

WHO IS IT FOR?

→ Students on exam platforms with paste restrictions
...
**Description :**
```
Chaque jour, des millions de personnes sont forcées de retaper du texte qu'elles ont déjà: parce qu'un site a décidé de bloquer le collage.
...
🧠 Mode Ultra-Humain: Ajoute des fautes de frappe réalistes et des auto-corrections pour un profil encore plus humain.

⚡ Vitesse Réglable: Lente, Normale, Rapide ou Instantanée. Vous contrôlez le rythme.

🕵️ Mode Incognito: Le texte sensible n'est jamais stocké dans l'historique.

🔑 Raccourci Clavier: Alt+Shift+V (Win) / Option+Shift+V (Mac).

🌍 6 Langues: English, Français, Español, Português, Italiano, Deutsch.

🔒 100% Privé: Aucune donnée ne quitte votre ordinateur.

POUR QUI ?

→ Les étudiants sur les plateformes d'examen avec restrictions
...
🕵️ Modo Incógnito: El texto sensible nunca se almacena.
🔑 Atajo de Teclado: Alt+Shift+V (Win) / Option+Shift+V (Mac).
🔒 100% Privado: Sin datos enviados a servidores.
```
...
🕵️ Modo Incógnito: Texto sensível nunca é armazenado.
🔑 Atalho de Teclado: Alt+Shift+V (Win) / Option+Shift+V (Mac).
🔒 100% Privado: Nenhum dado enviado a servidores.
```
...
🕵️ Modalità Incognito: Il testo sensibile non viene mai salvato.
🔑 Scorciatoia: Alt+Shift+V (Win) / Option+Shift+V (Mac).
🔒 100% Privato: Nessun dato inviato a server.
```
...
🕵️ Inkognito-Modus: Sensibler Text wird nie gespeichert.
🔑 Tastenkürzel: Alt+Shift+V (Win) / Option+Shift+V (Mac).
🔒 100% Privat: Keine Daten an Server gesendet.
```

---

## 🔑 Permission Justifications *(for Chrome Web Store review team)*

- **`activeTab`**: Required to inject the typing simulation into the specific input field where the user triggered the extension. Access is strictly limited to the active tab and only while the user is interacting with it.
...
- **`offscreen`**: Required to read the clipboard content programmatically without requiring repeated user interaction prompts. Used exclusively to retrieve clipboard text for the typing simulation.

- **`clipboardRead`**: Required to access the clipboard text that the user wants to type. Used only when the user explicitly triggers the extension.
